...
import gr.aueb.cf.moviesimdbapi2023.adapters.MovieAdepter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private MovieAdepter movieAdepter;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editText.getText().toString().trim().isEmpty()) {
                    ...
                    String url = "https://imdb-api.com/en/API/SearchMovie/k_s7p955dj/" + editText.getText().toString().trim();
                    ...
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                System.out.println("sizeof" + movieArrayList.size());// console in Locat the size of results that the API give us
                                recyclerView.setAdapter(new MovieAdepter(getApplicationContext(), movieArrayList));
